              ...
              <div class="card h-100 card-lift">
                ...
                <div class="card-body">
                  ...
                  >
                    ...
                    <div
                      class="icon-shape icon-md bg-primary-soft text-primary rounded-2"
                    >
                    ...
                    >
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <div class="avatar-group">
                              ...
                              <span class="avatar avatar-sm">
                                <img
                                  alt="bootstrap 5 avatar in circle"
                              ...
                              <span class="avatar avatar-sm avatar-primary">
                                <span
                                  class="avatar-initials rounded-circle fs-6"
                                  >+5</span
                                >
                              </span>
                            </div>
                        ...
                        <tr>
                          ...
                          <td>108</td>
                          <td>
                            <span class="badge badge-success-soft">Track</span>
                          </td>
                          <td>
                            <div class="avatar-group">
                              <span class="avatar avatar-sm">
