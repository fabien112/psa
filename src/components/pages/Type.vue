<template>
    <main id="main-wrapper" class="main-wrapper">
      ...
      <Modal v-model="modal" title="Nouveau type">
        <div class="row">
          
          <div class="col-12 pt-3">
            <input   placeholder="Nom" class="form-control"   v-model="forms.nom" />
            ...
            <div class="row">
              <div class="col-xl-12 col-12 mb-5">
                ...
                <div class="card">
                  ...
                  >
                    <h4 class="mb-0 text-white">Types</h4>
  ...
  export default {
    ...
    methods: {
      ...
      async save() {
        if (this.forms.nom == "") {
          this.e("Saisir le nom");
        } 
         else {
          this.$Spin.show();
          const response = await this.callApi(
            "post",
            process.env.VUE_APP_URL_API + "api/add-type",
            this.forms
          );
      ...
      async delate() {
        ...
        const response3 = await this.callApi(
          "post",
          process.env.VUE_APP_URL_API + "api/delate-type",
          this.item
        );
