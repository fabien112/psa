      ...
      <div class="container-fluid px-0 bg-color">
        ...
        <a id="nav-toggle" href="#!" class="ms-auto ms-md-0 me-0 me-lg-3">
          <svg
            ...
            height="28"
            fill="currentColor"
            class="bi bi-text-indent-left text-muted"
            viewBox="0 0 16 16"
          >
            <path
          ...
          <li class="dropdown stopevent ms-2">
            ...
            >
              <div>
                ...
                >
                  <p class="mb-0 text-dark fw-medium fs-4"> <router-link to="about">Notifications</router-link> </p>
                ...
                <div class="border-top px-3 py-2 text-center">
                  <a href="#!" class="text-inherit" @click="success"> View all Notifications </a>
                </div>
              </div>
            </div>
          </li>
